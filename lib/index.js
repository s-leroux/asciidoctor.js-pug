  ...
  const inherited = outils.patch(Document, '$create_converter', function() {
    ...
    */
    ...
    if (template_dirs) {
      ...
      // themplates, the last win
      // XXX Should I create a template object for each directory?
      templates = templates.concat([TemplateConverter.load_templates(template_dirs)]);
    }
